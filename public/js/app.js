    ...
    setUp: function setUp() {
      ...
      setTimeout(function () {
        ...
        function arrangePostsPosition() {
          var pos = posts_position;

          for (var k = 0; k < pos.length - 1; k++) {
            var count_same_top = 0;
            var count_same_bot = 0;
        ...
        function findCurrentYearByScroll() {
          ...
          // console.log(y);
          for (var i = 0; i < page_position.length; i++) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wuHeader_vue__ = __webpack_require__(176);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e21996a2", Component.options)
  } else {
    hotAPI.reload("data-v-e21996a2", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e21996a2", module.exports)
  }
}
