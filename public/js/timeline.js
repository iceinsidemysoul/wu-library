...
var Timeline = function () {
		function Timeline(current_year, year_lists) {
		...
		_createClass(Timeline, [{
				key: 'setTopPosition',
				value: function setTopPosition(item) {}
		}, {
				key: 'getTopPosition',
				value: function getTopPosition(item) {
						var h = item.height();
						var top = item.offset().top;
						return top - h / 2;
				}
		}, {
				key: 'showContentOfCurrentYear',
				value: function showContentOfCurrentYear() {
...
var timeLiner = new Timeline(current_year, year_lists);
